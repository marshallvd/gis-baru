...
<body>
    ...
    <nav class="navbar navbar-dark bg-oldmoney-darkest-charcoal px-4 col-12 d-lg-none">
        <a class="navbar-brand me-lg-5" href="../../index.html">
            <img class="navbar-brand-dark" src="{{ asset('img/brand/hmti.png') }}"
            ...
            <div
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar-lg me-4">
                        <img src="{{ asset('img/brand/hmti.png') }}"
                ...
                <li class="nav-item">
                    <a href="" class="nav-link d-flex align-items-center">
                        <span class="sidebar-icon">
                            <img src="{{ asset('img/brand/hmti.png') }}" height="20"
                            ...
                            <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button"
                                ...
                                <div class="media d-flex align-items-center">
                                    <img class="avatar rounded-circle" alt="Image placeholder"
                                        src="{{ asset('img/team/marshall1.jpg') }}">
